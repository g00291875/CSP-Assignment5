               ...
               try{
                 ...
                 // String playerNumberStr = playerNumber == PLAYER_X ? X_MARK : O_MARK );
                  ...
                  if (validateAndMove(location, playerNumber)) { // returns true if it's a valid move
                   ...
                   //  displayMessage("\nletting player who clicked know whats up\n");
